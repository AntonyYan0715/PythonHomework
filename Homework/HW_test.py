...
#example to use the function financial data, you will use the data from 2001-01-01 to 2022-01-01
...
ts=double_moving_average(goog_data, 30, 100) #use the correct parametres for a small time window of 30 and a long time window of 100
...
# dataframe positions
positions['TSLA'] = 10 * signals['signal']
